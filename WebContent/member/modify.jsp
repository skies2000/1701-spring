...
<form name='frm' method='post' action='modify_result.do'>
<label>회원 아이디</label>
<input type='text' name='modifyId' value=${memberVo.userid }><br/>
<input type='hidden' name='userid' value=${memberVo.userid }>
<label>회원 암호</label>
<input type='password' name='userpwd' value=${memberVo.userid }><p/>
